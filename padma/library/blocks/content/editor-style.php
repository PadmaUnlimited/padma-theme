...
function padma_content_block_editor_style() {
	...
	$body_font_size = PadmaElementsData::get_property('block-content-entry-content', 'font-size', '13');
	$body_line_height = PadmaElementsData::get_property('block-content-entry-content', 'line-height', '180');

	$body_headings_size = PadmaElementsData::get_property('block-content-heading', 'font-size', '20');
	$body_sub_headings_size = PadmaElementsData::get_property('block-content-sub-heading', 'font-size', '16');

	if ( !($body_hyperlink_color = PadmaElementsData::get_property('block-content-entry-content-hyperlinks', 'color', null)) )
