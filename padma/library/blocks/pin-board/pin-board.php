<?php
/**
 * Padma PinBoard Block main file.
 */
if ( ! class_exists( 'PadmaPinBoardCoreBlock' ) ) {
	...
	class PadmaPinBoardCoreBlock extends PadmaBlockAPI {
		...
		public static function enqueue_action( $block_id, $block = false ) {
			...
			/* CSS */
			wp_enqueue_style( 'padma-pin-board', padma_url() . '/library/blocks/pin-board/css/pin-board.css', array(), PADMA_VERSION, 'all' );

			/* JS */
			wp_enqueue_script( 'padma-pin-board', padma_url() . '/library/blocks/pin-board/js/pin-board.js', array( 'jquery' ), PADMA_VERSION, true );
		 ...
		 * @param boolean $infinite_scroll Should scroll.
		 * @param boolean $enumerate Enumerate.
		 * @return void
		 */
			...
			$this->inputs = array(
				...
				'text' => array(
					...
					'titles-position' => array(
							...
							'default' => 'below',
							'options' => array(
								'above' => __( 'Above', 'padma' ),
								'below' => __( 'Below', 'padma' ),
							),
						),
