...
class Padma_Theme_Updater {
	...
	function __construct( $args = array() ) {
		...
		$input_priority = $this->theme_slug == 'padma' ? -50 : 10;
		add_filter( 'padma_updater_products', array( &$this, 'add_theme_license_input' ), $input_priority );
