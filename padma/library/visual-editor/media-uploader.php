...
//wp_enqueue_script( 'media-editor', padma_url() . '/library/visual-editor/scripts/deps/media-editor.js', array( 'jquery' ) );
wp_localize_script( 'media-editor', '_wpMediaViewsL10n', $GLOBALS['wp_media_view_strings'] );

//wp_register_script( 'media-views', padma_url() . '/library/visual-editor/scripts/deps/media-views.js' );
